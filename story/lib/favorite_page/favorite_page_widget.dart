                            ...
                            Flexible(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'wohlbp11' /* Retrouvez ici toutes vos histo... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyLarge
                                        .override(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return ListView.separated(
                        ...
                        itemBuilder: (context, listViewIndex) {
                          ...
                          return StreamBuilder<List<StorieRecord>>(
                            stream: queryStorieRecord(
                              queryBuilder: (storieRecord) =>
                                  storieRecord.where(
                                'id',
                                isEqualTo: listViewFavoritesRecord.storyID,
                              ),
                              singleRecord: true,
                            ),
                            builder: (context, snapshot) {
                              ...
                              List<StorieRecord> containerStorieRecordList =
                                  snapshot.data!;
                              // Return an empty Container when the item does not exist.
                              if (snapshot.data!.isEmpty) {
                                return Container();
                              }
                              final containerStorieRecord =
                                  containerStorieRecordList.isNotEmpty
                                      ? containerStorieRecordList.first
                                      : null;
                                  ...
                                  context.pushNamed(
                                    ...
                                    queryParameters: {
                                      'title': serializeParam(
                                        containerStorieRecord?.title,
                                        ParamType.String,
                                      ),
                                      'time': serializeParam(
                                        containerStorieRecord?.time,
                                        ParamType.int,
                                      ),
                                      'description': serializeParam(
                                        containerStorieRecord?.description,
                                        ParamType.String,
                                      ),
                                      'storyRef': serializeParam(
                                        containerStorieRecord?.reference,
