...
import 'mystery_page_model.dart';
export 'mystery_page_model.dart';
...
class MysteryPageWidget extends StatefulWidget {
  const MysteryPageWidget({super.key});

  @override
  State<MysteryPageWidget> createState() => _MysteryPageWidgetState();
}

class _MysteryPageWidgetState extends State<MysteryPageWidget> {
  late MysteryPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MysteryPageModel());
  }
                            ...
                            Flexible(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      '6h9d82dn' /* Explorez des énigmes captivant... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyLarge
                                        .override(
