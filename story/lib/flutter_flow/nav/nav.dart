...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'fantasyPage',
          path: '/fantasyPage',
          builder: (context, params) => FantasyPageWidget(),
        ),
        FFRoute(
          name: 'storyPage',
          path: '/storyPage',
          builder: (context, params) => StoryPageWidget(
        ...
        FFRoute(
          name: 'readingPage',
          path: '/readingPage',
          builder: (context, params) => ReadingPageWidget(
            chapterRef: params.getParam(
              'chapterRef',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['storie', 'chapters'],
            ),
        ...
        FFRoute(
          name: 'mysteryPage',
          path: '/mysteryPage',
          builder: (context, params) => MysteryPageWidget(),
        ),
        FFRoute(
          name: 'childPage',
          path: '/childPage',
          builder: (context, params) => ChildPageWidget(),
        ),
        FFRoute(
          name: 'adventurePage',
          path: '/adventurePage',
        ...
        FFRoute(
          name: 'comedyPage',
          path: '/comedyPage',
          builder: (context, params) => ComedyPageWidget(),
        ),
        FFRoute(
          name: 'horrorPage',
          path: '/horrorPage',
          builder: (context, params) => HorrorPageWidget(),
        ),
        FFRoute(
          name: 'favoritePage',
          path: '/favoritePage',
